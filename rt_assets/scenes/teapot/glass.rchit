...
// #define PROB_ILLUMINANCE
// float dielectricSampleReflectionProb(const vec3 kr, const vec3 kt, float fr)
// {
//   // #ifdef PROB_ILLUMINANCE
//   const vec3 W = vec3(0.2125, 0.7154, 0.0721);
//   float sR = fr * dot(W, kr), sT = (1. - fr) * dot(W, kt);
//   return sR * safe_rcp(sR + sT);
//   // #else
//   //   return fr;
//   // #endif
// }
